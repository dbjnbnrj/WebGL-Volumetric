...
function init() {
    ...
    shader = new THREE.ShaderMaterial({
        ...
        fragmentShader: loadTextFile("shaders/vol-fs-single.glsl"),
        depthWrite:     false
    });
    ...
    for(var i = 0; i< 100; i++)
    {
        imagesA[i]=THREE.ImageUtils.loadTexture("textures/"+g.element+"/out"+i+".png");
    }
